...
$sql = "SELECT K_VALUE, MEMO, TEXT, LALA FROM SCHEDULE WHERE $search_tag LIKE '%$search_value%' and USERNAME = '$id'";
...
// output data of each row
 ...
 echo("<tr>");
 echo("<td>TITLE</td><td>MEMO</td><td>DATE</td><td>delete</td></tr>");

 while($row = $result->fetch_assoc()){
  //echo $row["K_VALUE"]. $row["LALA"];
  echo("<tr>");
  echo("<td>" . $row["TEXT"]. "</td><td>" . $row["MEMO"] . "</td><td>" . $row["LALA"] . "</td><td>");
  echo("<button onclick=");
  $cookie_1 = "Ca";
